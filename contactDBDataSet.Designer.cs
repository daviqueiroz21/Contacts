...
namespace Contacts {
    ...
    public partial class contactDBDataSet : global::System.Data.DataSet {
        ...
        public partial class peopleDataTable : global::System.Data.TypedTableBase<peopleRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public peopleRow AddpeopleRow(int ContactID, string Name, string Company, string Telephone, string Email, bool Client, System.DateTime LastCall) {
            ...
            private void InitClass() {
                ...
                this.columnLastCall.AllowDBNull = false;
            }
...
namespace Contacts.contactDBDataSetTableAdapters {
    ...
    public partial class peopleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[people] WHERE (([ContactID] = @Original_ContactID) AND ([Name] = @Original_Name) AND ([Company] = @Original_Company) AND ([Telephone] = @Original_Telephone) AND ([Email] = @Original_Email) AND ([Client] = @Original_Client) AND ([LastCall] = @Original_LastCall))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[people] ([ContactID], [Name], [Company], [Telephone], [Email], [Client], [LastCall]) VALUES (@ContactID, @Name, @Company, @Telephone, @Email, @Client, @LastCall);
SELECT ContactID, Name, Company, Telephone, Email, Client, LastCall FROM people WHERE (ContactID = @ContactID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[people] SET [ContactID] = @ContactID, [Name] = @Name, [Company] = @Company, [Telephone] = @Telephone, [Email] = @Email, [Client] = @Client, [LastCall] = @LastCall WHERE (([ContactID] = @Original_ContactID) AND ([Name] = @Original_Name) AND ([Company] = @Original_Company) AND ([Telephone] = @Original_Telephone) AND ([Email] = @Original_Email) AND ([Client] = @Original_Client) AND ([LastCall] = @Original_LastCall));
SELECT ContactID, Name, Company, Telephone, Email, Client, LastCall FROM people WHERE (ContactID = @ContactID)";
        ...
        public virtual int Delete(int Original_ContactID, string Original_Name, string Original_Company, string Original_Telephone, string Original_Email, bool Original_Client, System.DateTime Original_LastCall) {
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((bool)(Original_Client));
            this.Adapter.DeleteCommand.Parameters[6].Value = ((System.DateTime)(Original_LastCall));
        ...
        public virtual int Insert(int ContactID, string Name, string Company, string Telephone, string Email, bool Client, System.DateTime LastCall) {
            ...
            this.Adapter.InsertCommand.Parameters[5].Value = ((bool)(Client));
            this.Adapter.InsertCommand.Parameters[6].Value = ((System.DateTime)(LastCall));
        ...
        public virtual int Update(int ContactID, string Name, string Company, string Telephone, string Email, bool Client, System.DateTime LastCall, int Original_ContactID, string Original_Name, string Original_Company, string Original_Telephone, string Original_Email, bool Original_Client, System.DateTime Original_LastCall) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((bool)(Client));
            this.Adapter.UpdateCommand.Parameters[6].Value = ((System.DateTime)(LastCall));
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((bool)(Original_Client));
            this.Adapter.UpdateCommand.Parameters[13].Value = ((System.DateTime)(Original_LastCall));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Company, string Telephone, string Email, bool Client, System.DateTime LastCall, int Original_ContactID, string Original_Name, string Original_Company, string Original_Telephone, string Original_Email, bool Original_Client, System.DateTime Original_LastCall) {
